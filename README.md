...
This project analyses drink and drug driving offences in New Zealand to explore how offending behaviour and court outcomes have changed over the past two decades. The goal is to identify trends in offence outcomes, regional patterns, and changes in conviction rates over time. 
...
- Power Query
- Pivot Tables
- Data Visualisation (Dashboard & Slicers)
...
- Restructured raw data using Power Query
- Cleaned and prepared the dataset for analysis
- Performed exploratory analysis using Pivot Tables
- Built an interactive Excel dashboard with slicers to visualise trends and patterns
